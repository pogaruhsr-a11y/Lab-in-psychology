...
expName = 'stroop task final'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\hp\\OneDrive\\Desktop\\AU\\pratical psy\\Stroop Task final\\stroop task final_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Welcome\n\nIn this task, you will see words presented in different colors. You should ignore the world and respond  to the color of the text as quickly and accurately as possible.\n\n Press a key accoarding text color :\n\nPress R if the color is Red\n\n Press B if the color is Blue\n\n',
        font='Arial',
